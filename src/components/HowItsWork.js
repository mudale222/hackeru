            ...
            <div className="howItsWorkContainer container blackish text-right">
                ...
                <div className="ourProgressContainer d-none d-lg-block mb-5">
                    ...
                    <div className="row" id="cardsRow">
                        ...
                        <div id="card2" className="d-none col-lg-3 "><OurProgressCard color="#39A4DC" number='2' header='קורס מיון' text='שלב זה אורך בין 40-20 שעות על מנת לבדוק את יכולות המועמד ללימודי המשך ולהשמה בעבודה. לא עברת את שלב המיון ? תקבל החזר כספי של שכר הלימוד ששילמת' /></div>
                        <div id="card3" className="d-none col-lg-3 "><OurProgressCard color="#154B9C" number='3' header='ללכת על בטוח' text='אחרי שעברת את שלב המיון בהצלחה ונשמת לרווחה, תקבל התחייבות חוזית לעבודה ומלגת לימודים עד 7,000 ₪ תלוי במסלול שבחרת' /></div>
                        <div id="card4" className="d-none col-lg-3 "><OurProgressCard color="#352F8A" number='4' header='מתחילים ללמוד' text='הלימודים אצלנו פרקטיים ומטרתם לשלב את הבוגרים שלנו בתעשייה, לצורך זה תוכנית הלימודים שלנו היא המקצועית והמקיפה ביותר ובזכותה אנחנו מספר אחת בהשמת בוגרים בהייטק' /></div>
                    </div>
                </div>
